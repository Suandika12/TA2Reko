...
class _DataHariOperasionalScreenState extends State<DataHariOperasionalScreen> {
  ...
  void initState() {
    super.initState();
    getSession();
    fetchData(); // Tambahkan pemanggilan ini
  }
                ...
                children: [
                  DropdownButtonFormField<String>(
                    ...
                    onChanged: (String? newValue) {
                      setState(() {
                        valuePencarian = newValue!;
                      });
                    },
                    items: listPencarian.map((map) {
  ...
  void fetchData() async {
    BlocProvider.of<DataHariOperasionalBloc>(context)
        .add(FetchDataHariOperasional(filter));
  }

  void prosesHapus(value) {
    BlocProvider.of<DataHariOperasionalHapusBloc>(context)
        .add(FetchDataHariOperasionalHapus(data: value));
  }
